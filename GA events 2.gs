...
function runDemo_test_events_2() {
  try {
   ...
   var results = getReportDataForProfile_events('ga:eventaction,ga:source',firstProfile,'ga:source=~Nestoria;ga:eventaction=~risposta');
    ...
    // tiscali
     var results = getReportDataForProfile_events('ga:eventaction,ga:campaign',firstProfile,'ga:campaign=~tiscali;ga:eventaction=~risposta');
    ...
    var results = getReportDataForProfile_events('ga:eventaction,ga:campaign',firstProfile,'ga:campaign=~tiscali;ga:eventaction=~telefono');
